...
- Convert captured functions to defs for better performance (perform static analysis on AST to see if a function's only references are of the form `f.apply(...)`)
