...
Latest release: 0.3.3 ([Changelog](#changelog))
...
* Stream operations:
  ...
  * `isEmpty`, `nonEmpty`
  * `Option.get`, `getOrElse`, `isDefined`, `orNull`
...
* Remove all references to untypecheck
* Support the following rewrites:
  * `Option.orElse` (trickier than it seems: this is a sink + a potentially nested op)
  * ...?
